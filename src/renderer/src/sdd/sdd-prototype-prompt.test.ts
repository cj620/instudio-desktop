...
describe('buildSddPrototypeTurnPrompt', () => {
  it('binds the agent to the exact reserved prototype path', () => {
    const prompt = buildSddPrototypeTurnPrompt({
      mode: 'text',
      text: '需求：扫码登录页面。',
      prototypeRelativePath: '.xiaoyuansdd/requirements/123e4567-e89b-12d3-a456-426614174000/proto/prototype-1.html',
      workspaceRoot: '/tmp/ws'
    })
    expect(prompt).toContain('Reserved prototype file: .xiaoyuansdd/requirements/123e4567-e89b-12d3-a456-426614174000/proto/prototype-1.html')
    expect(prompt).toContain('`.xiaoyuansdd/requirements/123e4567-e89b-12d3-a456-426614174000/proto/prototype-1.html`')
  ...
  it('uses the custom prompt and the image specification wording in image mode', () => {
    const prompt = buildSddPrototypeTurnPrompt({
      mode: 'image',
      prototypeRelativePath: '.xiaoyuansdd/requirements/123e4567-e89b-12d3-a456-426614174000/proto/p.html',
      workspaceRoot: '/tmp/ws',
