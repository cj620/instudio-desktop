...
describe('buildWorkspaceProjectPickerOptions', () => {
  ...
  it('excludes conversation workspaces from project picker options', () => {
    ...
    const result = buildWorkspaceProjectPickerOptions({
      ...
      workspaceRoots: [
        '/Users/zxy/project-a',
        '/Users/zxy/Documents/Xiaoyuan/20260626-153012', // conversation workspace
        '/Users/zxy/project-b'
      ],
      conversationWorkspaceRoot: '/Users/zxy/Documents/Xiaoyuan'
    })
  ...
  it('includes regular project folders but excludes conversation workspaces', () => {
    const result = buildWorkspaceProjectPickerOptions({
      currentWorkspaceRoot: '/Users/zxy/Documents/Xiaoyuan/20260627-091234', // conversation workspace as current
      workspaceRoots: [
        '/Users/zxy/project-x',
        '/Users/zxy/project-y',
        '/Users/zxy/Documents/Xiaoyuan/20260626-153012' // another conversation workspace
      ],
      conversationWorkspaceRoot: '/Users/zxy/Documents/Xiaoyuan'
    })
    ...
    expect(optionRoots).not.toContain('/Users/zxy/Documents/Xiaoyuan/20260626-153012')

    // Current root should still be returned even if it's a conversation workspace
    expect(result.currentRoot).toBe('/Users/zxy/Documents/Xiaoyuan/20260627-091234')
  })
