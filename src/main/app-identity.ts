 ...
 *
 * 本产品「小元」由上游开源项目(Kun / DeepSeek GUI)fork 而来,作为
 * 全新产品独立发布。这个名字同时决定 userData 默认目录(appData/小元)。
 * 因为是全新产品、没有需要平滑升级的存量用户,所以 electron-builder 的
 * appId 也一并换成 com.instudio.xiaoyuan,与本文件无直接耦合但需保持
 * 与 main/index.ts 的 APP_USER_MODEL_ID、electron-builder.config.cjs#appId
 * 三处一致。
 */
export const APP_PRODUCT_NAME = '小元'
