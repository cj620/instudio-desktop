...
export const ARTIFACT_RULES = {
  darwin: {
    platformLike: /^(Kun|Xiaoyuan)-.*-mac-/i,
    pattern: new RegExp(`^(Kun|Xiaoyuan)-${VERSION_PART}-mac-(arm64|x64)\\.(dmg|zip)$`),
    ancillary: new RegExp(`^(Kun|Xiaoyuan)-${VERSION_PART}-mac-(arm64|x64)\\.(dmg|zip)\\.blockmap$`),
    required: [
      /-mac-arm64\.dmg$/,
      /-mac-arm64\.zip$/,
      /-mac-x64\.dmg$/,
  ...
  win32: {
    platformLike: /^(Kun|Xiaoyuan)-.*-win-/i,
    pattern: new RegExp(`^(Kun|Xiaoyuan)-${VERSION_PART}-win-x64\\.exe$`),
    ancillary: new RegExp(`^(Kun|Xiaoyuan)-${VERSION_PART}-win-x64\\.exe\\.blockmap$`),
